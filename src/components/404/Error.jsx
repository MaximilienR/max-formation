...
function Error() {
  return (
    <div className="container flex items-center justify-center p-4 mx-auto bg-red-200 rounded-2xl shadow-lg h-screen">
      <div className="w-full p-4 md:w-1/2 xl:w-1/3 text-center">
        <h1 className="text-9xl font-bold text-black mb-4">ERROR 404</h1>
