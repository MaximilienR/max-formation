    ...
    <div className="container flex items-center justify-center p-4 mx-auto bg-blue-400 rounded-2xl">
      <div className="w-full p-4 md:w-1/2 xl:w-1/3">
        ...
        <form className="flex flex-col">
          ...
          <div className="mb-4">
            <label htmlFor="password" className="block mb-2 font-bold text-white">Mot de passe</label>
            <input type="password" id="password" className="w-full p-2 bg-gray-100 border rounded" />
          </div>
